...
def ResNet50(input_shape=(64, 64, 3), classes=6):
    ...
    X = identity_block(X, f=3, filters=[256, 256, 1024], stage=4,
                       block="f")  # if you remove this block, you can get a accuracy at 96.666667% better than have this block
...
def ResNet50_Crowd(input_shape):
...
if __name__ == '__main__':
    model = ResNet50_Crowd(input_shape=(768, 1024, 3))
    model.summary()
